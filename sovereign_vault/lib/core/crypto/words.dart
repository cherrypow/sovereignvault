/// The official BIP-39 English wordlist (2,048 words), used to build
/// the vault's daily-unlock passphrase (see VaultPassphrase). Sourced
/// verbatim from the canonical bitcoin/bips reference so word order and
/// spelling exactly match the published standard.
const bip39EnglishWords = <String>[
