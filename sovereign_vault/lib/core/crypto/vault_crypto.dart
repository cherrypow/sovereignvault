...
/// (the passphrase, the master password) into 256-bit keys. Nothing in this
...
class VaultCrypto {
  ...
  /// Derives a 256-bit key from a human secret (passphrase or master
  /// password) and a salt, using Argon2id. Pass [kdf] to use a different
  /// cost profile than the daily-unlock default (see [argon2idExport]).
  ...
  /// Combines two independent secrets (e.g. a passphrase-derived key and a
